\begin{table*}[t]
\caption{A comparison of our AGQA with existing video question answering corpuses. AGQA is orders of magnitude larger than all existing benchmarks. It is also the first
...
MovieQA~\cite{tapaswi2016movieqa}  & 202.7 & 6.77 & \checkmark &  &  & & 6.4K  & & & \checkmark \\
SocialIQ~\cite{zadeh2019social} & 99 & 1.25 & \checkmark &  &  & & 7.5K \\
TVQA~\cite{lei2018tvqa} & 76.2 & 21.8 & \checkmark &  &  & \checkmark & 152.5K & & & \checkmark \\
...
\hline
\textbf{AGQA} & 30 & 9.6 & \checkmark & \checkmark & \checkmark & \checkmark &  \textbf{133M} & \checkmark & \checkmark & \checkmark\\
\end{tabular}}
\end{table*}